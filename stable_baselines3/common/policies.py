...
class BaseModel(nn.Module, ABC):
    ...
    def __init__(
        ...
        optimizer_QN_class: Type[th.optim.Optimizer] = th.optim.Adam,
    ):
        ...
        self.optimizer_QN_class = optimizer_QN_class
...
class ActorTwoCriticsPolicy(ActorCriticPolicy):
    ...
    def forward(self, obs: th.Tensor, deterministic: bool = False) -> Tuple[th.Tensor, th.Tensor, th.Tensor]: #important-----------------
        ...
        with th.no_grad():
            distributional_cost_values = self.cost_value_net_local(latent_cvf)
